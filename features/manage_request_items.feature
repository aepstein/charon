Feature: Manage request_items
  ...
  Scenario: Register new request_item
    ...
    And I fill in "request_item_sft" with "2"
  ...
  Scenario: Delete request_item
    Given the following request_items:
      |form_id|form_type|request_amount|requestor_comment|allocation_amount|allocator_comment|sft|rgt|request_node_id|
      |form_id 1|form_type 1|request_amount 1|requestor_comment 1|allocation_amount 1|allocator_comment 1|sft 1|rgt 1|request_node_id 1|
      |form_id 2|form_type 2|request_amount 2|requestor_comment 2|allocation_amount 2|allocator_comment 2|sft 2|rgt 2|request_node_id 2|
      |form_id 3|form_type 3|request_amount 3|requestor_comment 3|allocation_amount 3|allocator_comment 3|sft 3|rgt 3|request_node_id 3|
      |form_id 4|form_type 4|request_amount 4|requestor_comment 4|allocation_amount 4|allocator_comment 4|sft 4|rgt 4|request_node_id 4|
