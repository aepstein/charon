Feature: Manage request_items
  ...
  Scenario: Delete request_item
    Given the following request_items:
      |requestable_id|requestable_type|request_amount|requestor_comment|allocation_amount|allocator_comment|lft|rgt|request_node_id|
      |requestable_id 1|requestable_type 1|request_amount 1|requestor_comment 1|allocation_amount 1|allocator_comment 1|lft 1|rgt 1|request_node_id 1|
      |requestable_id 2|requestable_type 2|request_amount 2|requestor_comment 2|allocation_amount 2|allocator_comment 2|lft 2|rgt 2|request_node_id 2|
      |requestable_id 3|requestable_type 3|request_amount 3|requestor_comment 3|allocation_amount 3|allocator_comment 3|lft 3|rgt 3|request_node_id 3|
      |requestable_id 4|requestable_type 4|request_amount 4|requestor_comment 4|allocation_amount 4|allocator_comment 4|lft 4|rgt 4|request_node_id 4|
