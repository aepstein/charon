Feature: Manage editions
  ...
  Background:
    ...
    And a node: "external" exists with structure: structure "annual", requestable_type: "ExternalEquityReport", name: "external equity report"
  ...
  Scenario: Add and update edition (external_equity_report)
    ...
    And I fill in "edition_amount" with "0"
