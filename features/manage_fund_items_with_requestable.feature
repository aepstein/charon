Feature: Manage fund_items with fund_requestable
  ...
  Scenario: Administrative expense
    ...
    Then I should see "Maximum request: $164.00"
    ...
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $160.03"
  ...
  Scenario: Durable good expense
    ...
    When I select "Focus" from "Add New Root Item"
    And I press "Add Root Item"
    Then I should see "New Focus fund_item for Request of Applicant from FundSource"
    ...
    Then I should see "Fund item was successfully created."
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $250.00"
    And I should see "Requestor amount: $100.00"
    And I should see "Requestor comment: comment"
    ...
    Then I should see "Fund item was successfully updated."
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $280.00"
    And I should see "Requestor amount: $120.00"
    And I should see "Requestor comment: changed comment"
  ...
  Scenario: Publication expense
    ...
    Then I should see "Fund item was successfully created."
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $160.00"
    And I should see "Requestor amount: $100.00"
    And I should see "Requestor comment: comment"
    ...
    And I fill in "Requestor comment" with "changed comment"
    And I fill in "Reviewer amount" with "50"
    And I press "Update"
    Then I should see "Fund item was successfully updated."
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $50.00"
  ...
  Scenario: Local event expense
    ...
    And I press "Add Root Item"
    Then I should see "New Focus fund_item for Request of Applicant from FundSource"
    When I fill in "Start date" with "2009-08-18"
    And I fill in "End date" with "2009-08-18"
    ...
    And I choose "fund_item_fund_editions_attributes_0_local_event_expense_attributes_uup_required_true"
    And I choose "fund_item_fund_editions_attributes_0_local_event_expense_attributes_accessibility_considered_true"
    And I fill in "Requestor amount" with "3"
    And I fill in "Requestor comment" with "comment"
    And I press "Create"
    Then I should see "Fund item was successfully created."
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $3.00"
    And I should see "Requestor amount: $3.00"
    And I should see "Requestor comment: comment"
    And I should see "Start date: 2009-08-18"
    And I should see "End date: 2009-08-18"
    ...
    When I fill in "Start date" with "2009-08-19"
    And I fill in "End date" with "2009-08-20"
    ...
    And I choose "fund_item_fund_editions_attributes_0_local_event_expense_attributes_uup_required_false"
    And I choose "fund_item_fund_editions_attributes_0_local_event_expense_attributes_accessibility_considered_false"
    And I fill in "Requestor amount" with "0.3"
    And I fill in "Requestor comment" with "changed comment"
    And I fill in "Reviewer amount" with "0.3"
    And I press "Update"
    Then I should see "Fund item was successfully updated."
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $0.30"
    And I should see "Requestor amount: $0.30"
    And I should see "Requestor comment: changed comment"
    And I should see "Start date: 2009-08-19"
    And I should see "End date: 2009-08-20"
  ...
  Scenario: Travel event expense
    ...
    Then I should see "Fund item was successfully created."
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $3,084.00"
    ...
    When I follow "Edit"
    And I fill in "Start date" with "2009-09-02"
    And I fill in "End date" with "2009-09-03"
    ...
    And I fill in "Requestor comment" with "changed comment"
    And I fill in "Reviewer amount" with "1200"
    And I press "Update"
    Then I should see "Fund item was successfully updated."
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $1,652.00"
    And I should see "Requestor amount: $1,200.00"
    And I should see "Requestor comment: changed comment"
    And I should see "Start date: 2009-09-02"
    And I should see "End date: 2009-09-03"
  ...
  Scenario: Speaker expense
    ...
    Then I should see "Fund item was successfully created."
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $460.00"
    ...
    Then I should see "Fund item was successfully updated."
    When I follow "Show" for the 1st fund_item for fund_request: "focus"
    Then I should see "Maximum request: $665.00"
