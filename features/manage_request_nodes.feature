Feature: Manage request_nodes
  ...
  Scenario: Register new request_node
    ...
    And I fill in "request_node_requestable_type" with "Administrative"
  ...
  Scenario: Delete request_node
    Given the following request_nodes:
      |name|requestable_type|item_amount_limit|item_quantity_limit|request_structure_id|parent_id|
      |name 1|requestable_type 1|item_amount_limit 1|item_quantity_limit 1|request_structure_id 1|parent_id 1|
      |name 2|requestable_type 2|item_amount_limit 2|item_quantity_limit 2|request_structure_id 2|parent_id 2|
      |name 3|requestable_type 3|item_amount_limit 3|item_quantity_limit 3|request_structure_id 3|parent_id 3|
      |name 4|requestable_type 4|item_amount_limit 4|item_quantity_limit 4|request_structure_id 4|parent_id 4|
