  ...
  module ClassMethods
    ...
    def is_fulfillable
      has_many :fulfillments, :as => :fulfillable, :dependent => :delete_all do
        ...
        def fulfill!
          quoted_ft = connection.quote @association.owner.class.fulfiller_type
          underscore_ft = @association.owner.class.fulfiller_type.underscore
          fulfiller_ids = @association.owner.send(underscore_ft + "_ids")
          return true if fulfiller_ids.empty?
          q_fulfillable_type = connection.quote @association.owner.class.to_s
          ...
          connection.insert(
            ...
            "SELECT #{q_fulfillable_type}, #{@association.owner.id}, #{quoted_ft}, " +
            ...
            "AND fulfillments.fulfillable_id = #{@association.owner.id} " +
        ...
        def unfulfill!
          ...
          connection.delete(
            ...
            "#{q_fulfillable_type} AND fulfillable_id = #{@association.owner.id}" +
