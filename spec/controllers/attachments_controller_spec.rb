...
describe AttachmentsController do
  ...
  describe "GET index" do
    it "assigns all attachments as @attachments" do
      Attachment.stub!(:find).with(:all).and_return([mock_attachment])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested attachment as @attachment" do
      Attachment.stub!(:find).with("37").and_return(mock_attachment)
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new attachment as @attachment" do
      Attachment.stub!(:new).and_return(mock_attachment)
      get :new
      assigns[:attachment].should equal(mock_attachment)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created attachment as @attachment" do
        Attachment.stub!(:new).with({'these' => 'params'}).and_return(mock_attachment(:save => true))
