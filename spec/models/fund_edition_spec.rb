...
describe FundEdition do
  ...
  context 'validations' do
    ...
    xit "should enforce node item_quantity_limit" do
      ...
      excessive_item = create(:fund_item)
  ...
  it 'should destroy associated fund_item if no other editions exist' do
    fund_edition.save!
    fund_edition.fund_item.should_receive(:destroy)
    fund_edition.destroy
  end

  it 'should not destroy associated fund_item if another edition exists' do
    fund_edition.save!
    fund_edition.fund_item.should_not_receive(:destroy)
    item = fund_edition.fund_item
    item.association(:fund_editions).reset
    e = item.fund_editions.build_next_for_fund_request(
